...
from model import STGCNModel, CustomLSTM
...
# Settings - Match these to your best trained model
MODEL_TYPE = "STGCN"  # Options: "LSTM" or "STGCN"
# Update the path to your specific best checkpoint
MODEL_PATH = f'./model/best_{MODEL_TYPE}_epoch_22.pth'
GESTURES_PATH = 'gestures_02.npy'
...
if MODEL_TYPE == "STGCN":
    model = STGCNModel(num_classes=num_classes, adjacency_matrix=get_adjacency_matrix()).to(device)
else:
